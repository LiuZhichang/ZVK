...
namespace ImGui {
    ...
    *
    ...
    IMGUI_API void UpdateWindowParentAndRootLinks(ImGuiWindow * window, ImGuiWindowFlags
    flags,
    ...
    * window);
    ...
    IMGUI_API void SetWindowScrollX(ImGuiWindow * window, float
    new_scroll_x);
    IMGUI_API void SetWindowScrollY(ImGuiWindow * window, float
    new_scroll_y);
    ...
    * window);
    ...
    const ImVec2 &pos, ImGuiCond
    cond = 0
    );
    IMGUI_API void SetWindowSize(ImGuiWindow * window,
    const ImVec2 &size, ImGuiCond
    cond = 0
    );
    IMGUI_API void SetWindowCollapsed(ImGuiWindow * window, bool
    collapsed,
    ImGuiCond cond = 0
    );
    ...
    *
    ...
    id);   // Return true if focus is requested
    ...
    IMGUI_API void ClosePopupsOverWindow(ImGuiWindow * ref_window, bool
    restore_focus_to_window_under_popup);
    IMGUI_API bool IsPopupOpen(ImGuiID
    id); // Test for id within current popup stack level (currently begin-ed into); this doesn't scan the whole popup stack!
    ...
    * window);
    ...
    IMGUI_API void NavMoveRequestForward(ImGuiDir
    move_dir,
    ImGuiDir clip_dir,
    const ImRect &bb_rel, ImGuiNavMoveFlags
    move_flags);
    IMGUI_API void NavMoveRequestTryWrapping(ImGuiWindow * window, ImGuiNavMoveFlags
    move_flags);
    ...
    IMGUI_API void SetNavID(ImGuiID
    id,
    int nav_layer
    );
    IMGUI_API void SetNavIDWithRectRel(ImGuiID
    id,
    int nav_layer,
    ...
    IMGUI_API ImGuiColumns
    *
    FindOrCreateColumns(ImGuiWindow
    * window,
    ImGuiID id
    );
    ...
    * tab_bar,
    ...
    IMGUI_API void TabBarRemoveTab(ImGuiTabBar * tab_bar, ImGuiID
    tab_id);
    ...
    const char *label,
    bool *p_open, ImGuiTabItemFlags
    flags);
    IMGUI_API ImVec2

    TabItemCalcSize(const char *label, bool has_close_button);
    ...
    IMGUI_API bool CollapseButton(ImGuiID
    id,
    const ImVec2 &pos
    );
    ...
    * window,
    ...
    IMGUI_API bool DragBehavior(ImGuiID
    id,
    ...
    IMGUI_API void TreePushOverrideID(ImGuiID
    id);
    ...
    template<typename T, typename SIGNED_T> IMGUI_API T
    ...
    *
    ...
    inline bool TempInputTextIsActive(ImGuiID
    id) {
    ImGuiContext &g = *GImGui;
    return (g.ActiveId ==
    id &&g
